...
Function .onInit
Call RequireAdmin  CreateDirectory "$SMPROGRAMS\Ace Centre\EyeCommander"
...
;create start-menu items
  CreateDirectory "$SMPROGRAMS\Ace Centre\EyeCommander"
  CreateShortCut "$SMPROGRAMS\Ace Centre\EyeCommander\EyeCommander.lnk" "$INSTDIR\EyeCommander.exe" "" "$INSTDIR\EyeCommander.exe" 0
  CreateShortCut "$SMPROGRAMS\Ace Centre\EyeCommander\Help.lnk" "$INSTDIR\README.html" "" "$INSTDIR\README.html" 0
  CreateShortCut "$SMPROGRAMS\Ace Centre\EyeCommander\Uninstall.lnk" "$INSTDIR\Uninstall.exe" "" "$INSTDIR\Uninstall.exe" 0
...
Delete "$SMPROGRAMS\Ace Centre\EyeCommander\EyeCommander.lnk"
Delete "$SMPROGRAMS\Ace Centre\EyeCommander\Help.lnk"
Delete "$SMPROGRAMS\Ace Centre\EyeCommander\Uninstall.lnk"
RMDir /r "$INSTDIR"
SectionEnd