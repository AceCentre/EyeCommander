...
@click.option('--debug', '-d', is_flag=True, default=True, help='Want to log the output?')
@click.option('--outputkeys', '-k', is_flag=True, default=False, help='Presses arrow keys depending which way you look')
@click.option('--outputvjoy', '-j', is_flag=True, default=False, help='Presses vjoy buttons depending which way you look')
@click.option('--calibrate', '-c', is_flag=True, default=False, help='Do you want it to calibrate first?')
@click.option('--keepdata', is_flag=True, default=False, help='Do you want it to keep your trained data?')
@click.option('--sounds', is_flag=True, default=True, help='Do you want it to speak which direction it thinks you are looking?')
