...
@click.option('--debug/--no-debug', default=True, help='Want to log the output?')
@click.option('--outputkeys/--no-outputkeys', default=False, help='Presses arrow keys depending which way you look')
@click.option('--calibrate/--no-calibrate',  default=False, help='Do you want it to calibrate first?')
